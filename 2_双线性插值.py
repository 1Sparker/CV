...
def bilinear_interpolation(img, out_dim):
    ...
    scale_x, scale_y = float(src_h / dst_h), float(src_w / dst_w)  #计算原图与目标图长宽的缩放倍数
    for i in range(3):
        for dst_x in range(dst_h):
            for dst_y in range(dst_w):
                ...
                temp0 = (src_x1 - src_x) * img[src_x0, src_y0,i] + (src_x - src_x0) * img[src_x0,src_y1,i]
                temp1 = (src_x1 - src_x) * img[src_x1,src_y0,i] + (src_x - src_x0) * img[src_x1,src_y1,i]
